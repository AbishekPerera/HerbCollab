    ...
    <div class="col-lg-2">
      <div class="sidebar sidebar77">
        <ul class="nav flex-column">
          ...
          <li class="nav-item nav-item77">
            <Link class="nav-link nav-link77" to={"myorders"}>
              <i class="bi bi-cart-fill me-2"></i>My Orders
            </Link>
          </li>
          <li class="nav-item nav-item77">
            <Link to="mypreorders" class="nav-link nav-link77">
              <i class="bi bi-clock-history me-2"></i>Pre Orders
            </Link>
          </li>
          <li class="nav-item nav-item77">
            <Link to="myshipped" class="nav-link nav-link77">
              <i class="bi bi-truck me-2"></i>Shipped
            </Link>
          </li>
          <li class="nav-item nav-item77">
            <Link to="myreviews" class="nav-link nav-link77">
