...
console.log("IDD: ", id);
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`http://localhost:8071/products/update/${id}`, updateProduct).then(() => {
        ...
        <div className="content">
            ...
            onChange={(e) => {
              setImage(e.target.value);
                ...
                <button type="submit" class="btn btn-success" variant="secondary" onClick={handleSubmit}>Update Product</button>
